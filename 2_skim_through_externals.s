...
RUN PGM=HIGHWAY  MSG='Creating External Lookup Table by using Freeflow Skims'
    FILEI  NETI     = '2_skim_through_externals\input\USTM_NAT_Merged.net'

    FILEO  MATO     = '2_skim_through_externals\skm_USTMExt.mtx', mo=1-3, name=time, distance, external, numext
    
    FILEO PRINTO[1] = "2_skim_through_externals\ExternalLookup.csv"
    FILEO PRINTO[2] = "2_skim_through_externals\ExternalNumIJPairs.csv"
    FILEO PRINTO[3] = "2_skim_through_externals\ExternalMoreThan1.csv"
